...
ADDED_ADMIN_SUCCESSFULLY = (
    "Админ успешно добавлен!\n\n"
    "Теперь пользователь @id{admin_id} является \n\n"
    "Администратором для факультета {faculty}"
)

ADDED_SUPER_ADMIN_SUCCESSFULLY = (
    "Администратор успешно добавлен!\n\n"
    "Теперь пользователь @id{admin_id} суперадмин"
)
...
HELP = (
    ...
    "Список факультетов - выводит все факультеты"
)
